...
//   greet: function () {
//     console.log(
//       `Hello, I am ${this.name}, model ${this.model} built in ${this.year} by WDG21`
//     );
//   },
...
// console.log(robot.year);

// robot.greet();
// robot.performTask('analyse data');
...
// products.forEach(() => console.log('was called'));
// products.forEach((el, i, arr) => console.log(el, i, arr));
// products.forEach((el, i) => console.log(el, i));

// products.forEach((product) => console.log(product.title));

// const titles = products.forEach(function (product) {
...
// const search = products.filter(function (product) {
//   return product.title === 'Mens Cotton Jacket';
// });
// console.log(search);

// const result = products.filter((el) => el.title === 'Mens Cotton Jacket');
// console.log(result);
